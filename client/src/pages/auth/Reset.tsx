...
export default function Reset() {
    ...
    return (
        <div id="container-page" className="flex h-screen w-screen items-center justify-center bg-[linear-gradient(-45deg,#7F7EFF_30%,#1B1E24_40%)]">
            <div id="container-reset" className="mx-[5%] flex h-[80%] w-[70%] flex-row rounded-3xl bg-[#272334]">
                <div id="container-left" className="m-[5%] my-[10%] flex w-1/2 flex-col items-center gap-[15%]">
                    ...
                    <form onSubmit={reset} id="container-inputs" className="flex flex-col items-center gap-[1.875rem]">
                        ...
                        <div id="container-reset" className="flex w-[21.25rem] flex-col gap-[1rem] transition-all duration-[900ms]">
                            {success ? (
